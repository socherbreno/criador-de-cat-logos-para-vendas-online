...
with col1:
    ...
    try:
        ...
        st.warning("Logo não encontrada. Certifique-se de que a imagem logobrscribe.png está no GitHub.")
...
try:
    ...
    # Caso a internet falhe, mantém uma senha de emergência
        ...
        if uploaded_file is not None:
            ...
            if st.button("🚀 Iniciar Otimização em Massa"):
                ...
                for index, row in df.iterrows():
                    # --- CORREÇÃO FEITA AQUI ---
                    # Puxamos os dados da linha atual da planilha e transformamos em texto para a IA
                    dados_do_cliente = row.to_dict()
        ...
        """
                    try:
                        ...
                        if "DESCRIÇÃO:" in txt:
                            ...
                            df.at[index, 'TITULO_SEO'] = "Processado. Verifique o texto completo."
                            df.at[index, 'DESCRICAO_PERSUASIVA'] = txt.strip()
                        time.sleep(2)
